...
void main() {
  ...
  int peca2;
  peca2 = int.parse(entrada1[0]);
  int qtdPeca2;
  qtdPeca2 = int.parse(entrada1[1]);
  double valorPeca2;
  valorPeca2 = double.parse(entrada1[2]);
  ...
  print("VALOR A PAGAR: R\$ ${valorTotalVenda1.toStringAsFixed(2)}");
  print("VALOR A PAGAR: R\$ ${valorTotalVenda2.toStringAsFixed(2)}");
}
